...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 99058291, ; hash 0x5e78273, from name: ContentCreatorApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 353493789, ; hash 0x1511e31d, from name: libaot-ContentCreatorApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ContentCreatorApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 40
	...
	%struct.DSOCacheEntry {
		i64 1559483394, ; hash 0x5cf3d402, from name: aot-ContentCreatorApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ContentCreatorApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 174
	...
	%struct.DSOCacheEntry {
		i64 2656199035, ; hash 0x9e52617b, from name: aot-ContentCreatorApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ContentCreatorApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 305
	...
	%struct.DSOCacheEntry {
		i64 3491506308, ; hash 0xd01c2884, from name: libaot-ContentCreatorApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ContentCreatorApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 3870957587, ; hash 0xe6ba2013, from name: ContentCreatorApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ContentCreatorApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 448
